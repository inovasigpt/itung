        ...
        <div className="min-h-screen bg-kid-bg flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center px-6 pb-8">
                ...
                <div className="mb-8 animate-bounce-soft">
                    <div className="w-24 h-24 bg-kid-blue rounded-full flex items-center justify-center shadow-lg">
                        <span className="text-5xl">🤖</span>
                    </div>
                </div>

                {/* Title */}
                <h1 className="text-3xl font-bold text-kid-dark mb-2">Halo, Teman!</h1>
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-kid-lg border-2 border-gray-200 focus:border-kid-blue focus:outline-none transition-all text-kid-dark"
                    ...
                    <div className="text-right">
                        <Link to="/forgot-password" className="text-sm text-kid-blue hover:underline">
                            Lupa Password?
                        </Link>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-4 rounded-kid-lg bg-kid-blue text-white font-bold text-lg hover:bg-blue-600 btn-press transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <p className="mt-6 text-gray-500">
                    Belum punya akun?{' '}
                    <Link to="/signup" className="text-kid-blue font-semibold hover:underline">
                        Daftar
                    </Link>
                </p>
